...
//        }
        ...
        System.out.println("--每平价格->>" + DoubleMathUtils.div(amount, mianJi, 2));
        System.out.println("--贷款费用->>" + daiKuai);
        System.out.println("--个税->>" + geShui);
        System.out.println("--契税->>" + qiShui);
        System.out.println("--中介费->>" + zhongJie);
        System.out.println("--工本费+公证费+抵押工本费->>" + other);
//        System.out.println("--合计->>" + toChinese(shouFu + geShui + qiShui + zhongJie + daiKuai + other +""));
        System.out.println("--合计->>" + (shouFu + geShui + qiShui + zhongJie + daiKuai + other));
    }
}
