...
//                    System.out.println("==不存在==城市====");
    ...
    public static void processExpandObj(List<TreeNodeObject> objects, List<TreeNodeExpand<EntityCompare>> rootList, List<TreeNodeExpand<EntityCompare>> childList) {
        Map<String, Object> nodeMap = new HashMap<>();
        Map<String, Object> nodeMap2 = new HashMap<>();
        Map<String, Object> nodeMap3 = new HashMap<>();
        Map<String, Object> nodeMap4 = new HashMap<>();
...
//                            System.out.println("-------街道不存在------");
                            // 第四级
                            TreeNodeExpand childNode4 = new TreeNodeExpand<>(treeNode.getStreetCodeEx(), treeNode.getAreaCode(), treeNode.getStreetName(), null, new EntityCompare("json", "old_json", "new_value"));
                            childList.add(childNode4);
                            nodeMap4.put(treeNode.getStreetCodeEx(), true);
                        }
                    } else {
//                        System.out.println("==不存在==区====" + treeNode.getAreaName());
//                        // 保存一次下一级
                        TreeNodeExpand childNode4 = new TreeNodeExpand<>(treeNode.getStreetCodeEx(), treeNode.getAreaCode(), treeNode.getStreetName(), null, new EntityCompare());
                        childList.add(childNode4);
                        nodeMap4.put(treeNode.getStreetCodeEx(), true);
...
//                    System.out.println("==不存在==城市====");
                ...
                TreeNodeExpand rootNode = new TreeNodeExpand<>(treeNode.getProvinceCode(), null, treeNode.getProvinceName(), null,new EntityCompare("1_json", "1_old_json", "1_new_value"));
                rootList.add(rootNode);
                // 保存一次第二级
                TreeNodeExpand childNode2 = new TreeNodeExpand<>(treeNode.getCityCode(), treeNode.getProvinceCode(), treeNode.getCityName(), null, null);
                childList.add(childNode2);
